color [] colors = { 
  color(100, 200, 200), //Color del fondo
  color(100, 250, 200), //Color de las lineas
  color(80, 180, 180), //Color por defecto de los botones 
  color(100, 220, 220), //Color si tiene el mouseencima 
  color(100, 200, 200)//Color si se clickea,
};
